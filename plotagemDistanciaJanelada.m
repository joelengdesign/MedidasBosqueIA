...
for k = 1:4
    for j=1:4
        ...
        x1 = h_interna.distanciasR(in7);
        x2 = h_interna.distanciasR(in8);
        x3 = h_interna.distanciasR(in9);
        ...
        x1 = g_interna.distanciasR(in4);
        x2 = g_interna.distanciasR(in5);
        x3 = g_interna.distanciasR(in6);
